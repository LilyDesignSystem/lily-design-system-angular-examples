...
// WCAG conformance smoke check across the Angular examples app.
// Mirrors the per-app accessibility.spec.ts pattern used by the other
// 6 example apps. Covers home, catalog, sample component-detail pages,
// and the 12 composed-page demos.
