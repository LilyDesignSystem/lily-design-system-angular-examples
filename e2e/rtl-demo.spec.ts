...
// Plan P6-T4: the RTL demo route, ported from the canonical Svelte
...
// for the other six example apps: the theme-picker's pre-paint
// <link data-lily-theme-picker="theme"> finishes loading after
// page.goto() resolves, so a computed-style check run too early can
// read pre-theme values. waitForTheme() below waits for the managed
// link's sheet to populate, then two animation frames, before anything
// CSS-dependent runs.
