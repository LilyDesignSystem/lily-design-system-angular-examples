...
//
// Ported verbatim from lily-design-system-svelte-sveltekit-examples
// (src/lib/data/suffix-pattern.ts), the canonical reference. A slug's
// suffix pattern is derived purely from the slug string -- no
